...
import id.geekgarden.esi.data.model.openticket.responsespinnerengineer.Datum;
...
public class AdapterSpinnerEngineer extends ArrayAdapter<Datum> {
    private LayoutInflater inflater;
    private List<Datum> datumList;
    public AdapterSpinnerEngineer(@NonNull Context context, @LayoutRes int resource, List<Datum> list) {
