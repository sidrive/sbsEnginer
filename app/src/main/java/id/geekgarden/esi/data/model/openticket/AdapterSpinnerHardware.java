...
import id.geekgarden.esi.data.model.openticket.responsehardware.Datum;
...
public class AdapterSpinnerHardware extends ArrayAdapter<Datum> {
    private LayoutInflater inflater;
    private List<Datum> datumList;
    public AdapterSpinnerHardware(@NonNull Context context, @LayoutRes int resource, List<Datum> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        tvSpinner.setText(datumList.get(position).getCode());
        return view;
