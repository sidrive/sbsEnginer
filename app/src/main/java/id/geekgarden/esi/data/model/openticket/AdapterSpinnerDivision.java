...
public class AdapterSpinnerDivision extends ArrayAdapter<Datum> {
    private LayoutInflater inflater;
    private List<Datum> datumList;
    public AdapterSpinnerDivision(@NonNull Context context, @LayoutRes int resource, List<Datum> list) {
