...
import id.geekgarden.esi.data.model.tikets.staffticket.adapter.AdapterChecklistPmIt.ViewHolder;
...
public class AdapterChecklistPmIt extends Adapter<ViewHolder> {
  ...
  public AdapterChecklistPmIt(ArrayList<ChecklistItem> items, Context context,
