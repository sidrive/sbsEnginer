...
import id.geekgarden.esi.data.model.openticket.responsespinnerrequest.Datum;
...
public class AdapterSpinnerRequest extends ArrayAdapter<Datum> {
    private LayoutInflater inflater;
    private List<Datum> datumList;
    public AdapterSpinnerRequest(@NonNull Context context, @LayoutRes int resource, List<Datum> list) {
