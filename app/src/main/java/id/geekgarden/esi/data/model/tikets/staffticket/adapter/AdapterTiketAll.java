...
import id.geekgarden.esi.data.model.tikets.staffticket.adapter.AdapterTiketAll.Holder;
...
public class AdapterTiketAll extends Adapter<Holder> {

  private List<Datum> mTikets;
  private Context mContext;
  OnTiketPostItemListener ontiketpostItemListener;

  public AdapterTiketAll(ArrayList<Datum> tiketsItems, Context context,
      OnTiketPostItemListener ontiketpostItemListener) {
  ...
  public void onBindViewHolder(Holder holder, int position) {
    ...
    tv09.setText(
        tiketsItem.getTicketType().getData().getName() + " " + tiketsItem.getRequest() + tiketsItem
            .getTicketActivityId());
