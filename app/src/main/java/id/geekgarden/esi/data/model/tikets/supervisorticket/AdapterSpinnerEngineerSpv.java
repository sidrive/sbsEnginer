...
public class AdapterSpinnerEngineerSpv extends ArrayAdapter<Datum> {
    private LayoutInflater inflater;
    private List<Datum> datumList;
    public AdapterSpinnerEngineerSpv(@NonNull Context context, @LayoutRes int resource, List<Datum> list) {
