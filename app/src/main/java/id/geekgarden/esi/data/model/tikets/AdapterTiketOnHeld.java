...
public class AdapterTiketOnHeld extends RecyclerView.Adapter<AdapterTiketOnHeld.Holder> {
    private List<Datum> mTikets;
    private Context mContext;
    AdapterTiketOnHeld.OnTiketPostItemListener ontiketpostItemListener;

    public AdapterTiketOnHeld(ArrayList<Datum> tiketsItems, Context context, AdapterTiketOnHeld.OnTiketPostItemListener ontiketpostItemListener) {
    ...
    @Override
    public AdapterTiketOnHeld.Holder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.item_list_tiket, parent, false);
        AdapterTiketOnHeld.Holder holder = new AdapterTiketOnHeld.Holder(view, this.ontiketpostItemListener);
        return holder;
    }

    @Override
    public void onBindViewHolder(AdapterTiketOnHeld.Holder holder, int position) {
    ...
    public class Holder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public Holder(View itemView, AdapterTiketOnHeld.OnTiketPostItemListener ontiketpostItemListener) {
