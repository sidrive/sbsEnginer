...
import id.geekgarden.esi.data.model.openticket.responsespinnercustomer.Datum;
...
public class AdapterSpinnerCustomer extends ArrayAdapter<Datum> {
    private LayoutInflater inflater;
    private List<Datum> datumList;
    public AdapterSpinnerCustomer(@NonNull Context context, @LayoutRes int resource, List<Datum> list) {
